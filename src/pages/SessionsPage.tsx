...
import { Activity, Database, Download, Edit3, PauseCircle, Play, Search, SkipForward, Trash2, X } from "lucide-react";
import {
  createColumnHelper,
  flexRender,
  getCoreRowModel,
...
export default function SessionsPage({
  ...
  const columns = useMemo(
    ...
    [columnHelper, renamingId, renameValue, confirmDeleteId, onDeleteSession, onRenameSession, onExportCsv, onLoadPlayback],
  );
      ...
      <main className="sessions-main">
        <div className="panel wide sessions-history-panel panel-fill">
          ...
          {sessions.length === 0 ? (
            ...
            <div className="sessions-table-wrap layout-scroll">
